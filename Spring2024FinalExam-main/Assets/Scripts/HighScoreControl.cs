...
public class HighScoreControl : MonoBehaviour
{
    ...
    public string addScoreURL =
            "http://localhost/price66/addscore.php?";
    public string highscoreURL =
             "http://localhost/price66/display.php";
    ...
    {
        StartCoroutine(PostScores(saveNames.playerName, Convert.ToInt32(playerControl.scoreText.text)));
